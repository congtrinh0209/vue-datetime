...
exports.default = {
  ...
  data: function data() {
    ...
    return {
      ...
      typeFlow: (0, _TypeFlows2.default)(this.type, this, date ? date.clone() : (0, _moment2.default)().locale(this.momentLocale)),
  ...
  watch: {
    value: function value(newValue) {
      ...
      this.typeFlow.setDate(this.date ? this.date.clone() : (0, _moment2.default)().locale(this.momentLocale));
  ...
  computed: {
    ...
    currentMonthDays: function currentMonthDays() {
      ...
      var days = util.monthDays(currentMonth, currentYear, this.mondayFirst, this.heightFixed);
  ...
  methods: {
    getDate: function getDate() {
      return this.value.length ? (0, _moment2.default)(this.value, this.type === 'time' ? 'HH:mm' : null).locale(this.momentLocale) : null;
    },
    getNewDate: function getNewDate() {
      var newDate = this.date ? this.date.clone() : (0, _moment2.default)().locale(this.momentLocale);
    ...
    selectMonth: function selectMonth(monthName) {
...
function weekdays(momentLocale) {
  var mondayFirst = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

  var weekdays = _moment2.default.localeData(momentLocale).weekdaysMin();
  if (mondayFirst) {
...
function monthDays(month, year) {
  ...
  var heightFixed = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  ...
  var num_of_days = monthDate.daysInMonth() + firstDay;
  var days = new Array(heightFixed ? 35 : num_of_days).fill(null);
  var data = days.map(function (value, index) {
    if (heightFixed) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.show === 'month'),
      expression: "show === 'month'"
    }],
    staticClass: "vdatetime-popup__list-picker-wrapper"
  }, [_c('div', {
    ref: "monthPicker",
    ...
    return _c('div', {
      staticClass: "vdatetime-popup__list-picker__item",
      class: {
        'vdatetime-popup__list-picker__item--selected': month.selected
      },
      on: {
        "click": function($event) {
          _vm.selectMonth(month.name)
        }
      }
  ...
  }, [_vm._v(_vm._s(_vm.i18n.cancel))]), _vm._v(" "), _c('div', {
    staticClass: "vdatetime-popup__actions__button",
    on: {
      "click": _vm.ok
    }
  }, [_vm._v(_vm._s(_vm.i18n.ok))])])])]) : _vm._e()])], 1)
},staticRenderFns: []}
